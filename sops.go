...
command line client via `go get -u github.com/tozd/sops/v3/cmd/sops`, or use the
decryption helper provided at `github.com/tozd/sops/v3/decrypt`.

We do not guarantee API stability for any package other than `github.com/tozd/sops/v3/decrypt`.
...
ordering.
*/
package sops //import "github.com/tozd/sops/v3"
...
import (
	...
	"github.com/tozd/sops/v3/audit"
	"github.com/tozd/sops/v3/keys"
	"github.com/tozd/sops/v3/keyservice"
	"github.com/tozd/sops/v3/logging"
	"github.com/tozd/sops/v3/shamir"
